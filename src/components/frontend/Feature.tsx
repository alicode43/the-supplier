...
function Feature({
  ...
  return (
    <section className="container mx-auto px-4 py-16 md:py-24 md:w-4/5">
      <div
        className={`flex  md:flex-${direction}  flex-col gap-8 lg:gap-44 items-center`}
      >
        <div className="order-2 lg:order-1 w-full max-w-lg mx-auto md:min-w-2/6">
          {img && (
        ...
        <div className="order-1 lg:order-2 space-y-6">
          ...
          {isButton ? (
            <CustomButton icon={buttonIcon} text={buttonText} />
          ) : (
            <></>
          )}
        </div>
