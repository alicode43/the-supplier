...
function Page() {
  ...
  <Feature
          ...
          isButton={false}
          subTitle=" "
          title="What is CNC Milling"
          direction="row-reverse"
          description="CNC milling stands at the forefront of CNC machining, utilizing computer numerical control technology to automate precise material removal from workpieces. By interpreting digital designs, CNC milling machines execute intricate tool paths with unmatched accuracy, facilitating efficient component production across diverse industries.   

With its versatility in materials and geometries, CNC milling ensures precision in aerospace, automotive, electronics, and medical device manufacturing. Seamlessly integrating advanced automation, CNC milling drives manufacturing innovation, delivering superior results, and setting new standards in precision engineering. As businesses seek enhanced efficiency and quality in production processes, CNC milling emerges as a pivotal technology, empowering industries to meet evolving demands with confidence and precision."
        />
