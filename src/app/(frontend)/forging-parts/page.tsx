...
function ForgingPartsPage() {
  ...
  const forgingDescription = (
    <>
      <span className="text-white font-bold">High-Precision Forging:</span> Our
      advanced forging processes deliver exceptional strength and structural
      integrity, ensuring components meet exact functional specifications and
      performance requirements.
      <br />
      <span className="text-white font-bold">Material Expertise: </span>
      We work with premium steel, aluminum, titanium, and various alloys to
      create customized forging solutions perfectly tailored to your application
      requirements.
      <br />
      <span className="text-white font-bold">
        Superior Finishing & Quality:
      </span>{" "}
      All forged components undergo comprehensive refinement through
      state-of-the-art heat treatment, machining, and finishing processes to
      achieve optimal mechanical properties and surface quality.
    </>
  );
  return (
    <div>
